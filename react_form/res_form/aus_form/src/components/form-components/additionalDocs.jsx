...
const AdditionalDocs = () => {
  return (
    <>
      <div
        className="p-2 px-3 my-1 border-top border-bottom bg-light d-flex align-items-start justify-content-between shadow h-100"
      ...
      >
        <div className="w-lg-25 d-flex flex-column align-items-lg-start justify-content-center">
          ...
          <button type="button" class="btn btn-light p-2 px-3 border">
            <span className="rounded" style={{ color: "#6c8dab" }}>
      ...
      <div
        className="p-2 px-3 my-1 border-top border-bottom bg-light d-flex d-lg-none align-items-start justify-content-between shadow w-100"
        style={{ maxWidth: `${window.innerWidth}` }}
      >

...
const PersonalInfoForm = () => {
  return (
    <>
      <div
        className="p-2 px-3 my-1 border-top border-bottom bg-light d-flex justify-content-center align-items-start flex-column shadow "
      ...
      <div
        className="p-2 px-3 my-1 border-top border-bottom bg-light d-flex justify-content-center align-items-start flex-column w-100 shadow "
        style={{ maxWidth: `${window.innerWidth}` }}
      >

...
export default function FormLayout() {
    ...
    return (
        <>
            ...
            <DescriptionSection>
                <span>
                    <strong>{`Complete Steps 2–4 ONLY if they apply to you; otherwise, skip to Step 5.`}</strong> See page 2 for
                     more information on each step, who can claim exemption from withholding, and when to use the 
                     estimator at <a className="text-decoration-none" href="www.irs.gov/W4App.">www.irs.gov/W4App.</a>)
                </span>
            </DescriptionSection>
            <CustomFormHeading>
